                        ...
                        <div class="right six columns">
                        	...
                        	<!-- 提示登陆 -->
									<div class="login">
										...
										Welcome <%= user.getUserName() %>, you can check your orders <a href="my_order.jsp"><strong>my orders</strong>
                ...
                <div class="row">
                    ...
                    <!-- *******************checkout result*************************** -->
                        	<section class="content">
                                ...
                                <div class="breadcrumb"><a href="index.jsp">Home</a> / Checkout Result</div>
                                <h1 class="pagetitle">Checkout Result</h1>
                                    ...
                                    <table id="cart_summary">
                                        ...
                                        <tfoot>
                                            <tr class="cart_total price">
                                                ...
                                                <td id="product" class="price"><%=item.getName() %></td>
                                            </tr>
                                            ...
                                            <tr class="cart_total excl">
                                                ...
                                                <td id="total_price_without_tax" class="price"><%=user.getAccount() %></td>
                                            </tr>
